<?php
 ...
 $debug = true;  // set to true is you want raw results to be displayed
 $ServerIP = "55.171.1.48"; // Your VC IP address or dns name 
 $username = "cnamts\c417501-vcro";
 $password = "Serp!l2016";
...
<?php
 require_once("../class/nusoap_client.php");
 ...
 $result = $myconnection->call("RetrieveServiceContent", $soapmsg);
